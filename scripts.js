function problemOne() {
  ...
  var lowScore = Math.min(num1, num2, num3, num4, num5, num6);
  var average = ((num1 + num2 + num3 + num4 + num5 + num6 - lowScore)/5);
...
function problemTwo() {
  ...
  //Compute the GPA.
  var gradeTotal = findGPA(grade1, grade2, grade3, grade4, grade5, grade6, grade7);
...
function findGPA(grade1, grade2, grade3, grade4, grade5, grade6, grade7) {
  let list = [grade1, grade2, grade3, grade4, grade5, grade6, grade7];
